$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Mike and Fawns's Wedding",

            // Event start date
            start: new Date('Dec 5, 2020 18:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b15cc4fb237532b62a0491ccd19a4c42') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbwe2QeDe_WGbYH8KI5wvpkDkebeNOyWyC25iz76fw/exec', data + "&Attendence=Yes")
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = {lat: 32.7139859, lng: -117.1595188};
...
//     var la_fiesta = {lat: 32.7139859, lng: -117.1595188};
//     var map = new google.maps.Map(document.getElementById('map-canvas'), {
//         zoom: 15,
//         center: la_fiesta,
//         scrollwheel: false
